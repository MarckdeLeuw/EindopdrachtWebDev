...
})({"cXv6x":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a2232c5cc33acbbb";
...
},{}],"aISCU":[function(require,module,exports) {
...
async function fetchAnalyzedRecipeInstructions() {
    try {
        const response = await _axiosDefault.default.get(requestInstructions, {
            params: {
...
async function fetchIngredientsById() {
    ...
    try {
        const response = await _axiosDefault.default.get(requestIngredients, {
...
/*==================================================================================
3.1 FUNCTIE INNER HTML OM RECIPE INGREDIENTS TE PLAATSEN
==================================================================================*/ function createIngredients(ingredients1) {
    const ingredientList = document.getElementById("recipe-ingredients");
    ingredientList.innerHTML = ingredients1.map((ingredient)=>{
        return `   
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./dataInput":"fMq9m"}],"jo6P5":[function(require,module,exports) {
...
},{}],"fMq9m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cXv6x","aISCU"], "aISCU", "parcelRequire6362")

//# sourceMappingURL=recipe.c33acbbb.js.map
