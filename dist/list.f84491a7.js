...
})({"lY4yM":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "86d2e6b3f84491a7";
...
},{}],"edNoW":[function(require,module,exports) {
...
for(let i = 0; i < _dataInput.inventory.length; i++){
    listAll.innerHTML += `${categoryItem(_dataInput.inventory[i])}`;
    const productList = document.getElementById(_dataInput.inventory[i].category);
    for(let j = 0; j < _dataInput.inventory[i].products.length; j++)productList.innerHTML += `${listItem(_dataInput.inventory[i].products[j])}`;
}
/*=====================================================
2.4 ELKE CHECKBOX KRIJGT EVENT LISTENER
...
for(let i1 = 0; i1 < _dataInput.inventory.length; i1++)for(let j = 0; j < _dataInput.inventory[i1].products.length; j++)button(_dataInput.inventory[i1].products[j]).addEventListener('click', handleInputChange);
/*=====================================================
3.0 ACTIES BIJ SELECTEREN PRODUCTEN
=====================================================*/ /*=====================================================
3.1 IN SELECTED LIJST ZETTEN
...
for(let j1 = 0; j1 < selectedItems.length; j1++)productListChosen.innerHTML += `${listSelected(selectedItems[j1])}`;
/*=====================================================
...
====================================================================================*/ function handleInputChange(e) {
    ...
    for(let j2 = 0; j2 < selectedItems.length; j2++)productListChosen.innerHTML += `${listSelected(selectedItems[j2])}`;
...
=====================================================*/ function createRecipeList(recipes) {
    ...
    recipes.map((recipe)=>{
        ...
        let missedItems = [];
        for(let i3 = 0; i3 < listMissed.length; i3++)missedItems.push(listMissed[i3].name);
    ...
    for(let i2 = 0; i2 < recipes.length; i2++)button1(recipes[i2].id.toString()).addEventListener('click', clickRecipe);
}
/*=====================================================
4.4 RECIPE DETAIL
...
function clickRecipe(e) {
    const currentValue = e;
    for(let i4 = 0; i4 < allRecipes.length; i4++){
        let recipe = document.getElementById(`place-ref-${allRecipes[i4].id}`);
        recipe.replaceChildren();
        // console.log(currentValue.target.id);
        // console.log(allRecipes[0].id);
        if (currentValue.target.id == allRecipes[i4].id) {
            recipeDetails.id = allRecipes[i4].id;
            recipeDetails.title = allRecipes[i4].title;
            recipeDetails.image = allRecipes[i4].image;
...
},{"./../utils":"5By4s"}]},["lY4yM","edNoW"], "edNoW", "parcelRequire6362")

//# sourceMappingURL=list.f84491a7.js.map
